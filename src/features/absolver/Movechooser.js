...
/**
 * A representation of the interface that the deckbuilder goes into when a move slot is selected. It contains
 * a combo or alt component, and a movelist component.
 * @component
